...
namespace DGTickets.Backend.Migrations
{
    ...
    [Migration("20241128215453_QuantityTicketMedicine")]
    partial class QuantityTicketMedicine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DGTickets.Shared.Entities.TicketMedicine", b =>
                {
                    b.HasOne("DGTickets.Shared.Entities.MedicineStock", "Medicine")
                        .WithMany("TicketMedicines")
                        .HasForeignKey("MedicineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DGTickets.Shared.Entities.Ticket", "Ticket")
                        .WithMany("TicketMedicines")
