...
public partial class AddMedicineForm
{
    ...
    [EditorRequired, Parameter] public TicketMedicineDTO TicketMedicineDTO { get; set; } = null!;
    ...
    {
        editContext = new(TicketMedicineDTO);
    }
    ...
    private void MedicineChanged(MedicineStock medicine)
    {
        ...
        TicketMedicineDTO.MedicineId = medicine.Id;
    }
}